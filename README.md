...
- [MPV Standalone](https://mpv.io/installation/) (optional) ThumbFast will not work properly if you are on older versions of mpv.net without this ([Refrence](https://github.com/po5/thumbfast?tab=readme-ov-file#mpv-frontends))
